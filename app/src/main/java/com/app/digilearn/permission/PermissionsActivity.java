package com.app.digilearn.permission;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS = "com.app.homybee.EXTRA_PERMISSIONS";
    ...
    private boolean hasAllPermissionsGranted(@NonNull int[] grantResults) {
        for (int grantResult : grantResults) {
            if (grantResult == PackageManager.PERMISSION_DENIED) {
                return true; //menghilangkan pop-up permission ganti dari false menjadi true menghilangkan
            }
        }
        return true;
    }
